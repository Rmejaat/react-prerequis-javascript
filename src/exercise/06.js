...
const exercice = () => {
  ...
  displayText(
    `Y a t-il au moins un pc avec un ssd-500go ? : ${computers.some((computer) => computer.features.includes("ssd-500go"))}`
  )
  ...
  displayText(
    `Tous les pc ont un ssd-500go ? : ${computers.every((computer) => computer.features.includes("ssd-500go"))}`
  )
